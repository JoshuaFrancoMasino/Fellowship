/*
  # Add Media Support to Chats and Comments
  ...
  2. Storage Bucket
    - Create 'chat-and-comment-media' bucket for user-uploaded media
    - Set up appropriate RLS policies for media access
...
-- Create storage bucket for chat and comment media
INSERT INTO storage.buckets (id, name, public)
VALUES ('chat-and-comment-media', 'chat-and-comment-media', true)
ON CONFLICT (id) DO NOTHING;

-- Set up storage policies for chat and comment media
